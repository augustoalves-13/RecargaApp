...
export default function CellphonePagamentoScreen({ route, navigation }) {
    ...
    const { selectedItem, rechargeValue } = route.params
            ...
            <View style={[StylesComponent.boxContent, { height: "95%" }]}>
                ...
                <View style={{ width: '100%', height: '40%',alignItems: "center", justifyContent:"center" , gap: 10 }}>
                    <PayButton
                        ...
                        onPress={() => navigation.navigate("PixScreen", { rechargeValue })}
                        title='Pix'
                    />
                    <PayButton
                        SvgImg={
                        ...
                        onPress={() => navigation.navigate("SaveCardCellphone", { rechargeValue, selectedItem })}
                        title='Débito'
                    />
                    <PayButton
                        SvgImg={
